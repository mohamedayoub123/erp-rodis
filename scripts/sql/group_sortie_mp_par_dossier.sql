-- Regroupe les sorties MP par dossier (Doss ERP + Doss 4D) au sein d'un
-- meme lot de validation (un seul appel a cette fonction), au lieu de
-- toujours forcer TOUTES les lignes approuvees ensemble dans un seul TS -
-- si deux lignes validees ensemble ont des dossiers differents, elles
-- forment deux TS distincts. Le regroupement ne s'etend jamais a un appel
-- precedent : meme dossier, mais valide a un autre moment = un autre TS.
