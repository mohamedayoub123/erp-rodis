...
export default async function StockDormantPage({
  ...
  // Export sur filteredRows (tout ce qui correspond aux filtres actifs),
  // pas seulement la page affichee - meme convention que le Dormant MP
  // (app/stock/matiere-premiere/dormant/page.tsx).
  const exportColumns = [
