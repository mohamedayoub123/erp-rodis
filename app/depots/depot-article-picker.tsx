...
// Un depot peut contenir des articles MP et PF melanges - ce choix
// (article_type, champ radio natif du formulaire) determine simplement
// quelle liste d'articles alimente ProduitPickerField. "key={type}" force
...
export function DepotArticlePicker({
  articlesMp,
  articlesPf,
}: {
