...
export default async function RecetteFabricationListPage({ searchParams }: { searchParams: SearchParams }) {
  noStore();
        ...
        <div className="flex flex-col gap-4 rounded-[2rem] border border-black/5 bg-white/85 p-6 shadow-[0_18px_50px_rgba(15,23,42,0.08)] backdrop-blur sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-600 sm:text-base">
              Liste des produits vrac (article PF avec nature &quot;Vrac&quot;). Choisis un produit
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="/production/recette-fabrication/nouvelle"
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full text-left text-sm">
                <thead className="sticky top-0 z-10 bg-slate-50 text-slate-500">
                  <tr>
                    <th className="px-6 py-4 font-semibold">Produit vrac</th>
                  ...
                  {filteredArticles.map((article) => (
                    <tr key={article.id} className="border-t border-slate-100">
                      ...
                      <td className="px-6 py-4">
                        <Link
                          href={`/production/recette-fabrication/${article.id}`}
