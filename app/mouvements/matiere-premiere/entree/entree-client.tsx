...
import { EntreePanelMp, type ArticleMpOption, type LotMpOption } from "../staged-movements-mp";

export function EntreeMpClient({
  articles,
  canWrite,
}: {
  ...
  const [, setLotsState] = useState<LotMpOption[]>([]);
  ...
  return <EntreePanelMp articles={articles} onLotsCreated={setLotsState} />;
}
