...
// second champ "Nombre de jours pour tout finir" (demande explicite) :
// remplir l'un recalcule l'autre a partir du total de lots en stock. Le
// champ soumis au formulaire (name="taille_lot") reste celui de gauche, que
// sa valeur vienne d'une saisie directe ou d'un calcul via le nombre de
// jours - jamais 2 affichages separes qui ne se parlent pas.
