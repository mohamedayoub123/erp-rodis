...
// le total de CE perimetre, pas le total global du PF. Meme regle "OR"
// entre categorie et gamme que distribuerProchainLot (actions.ts) - meme
// fonction que cote MP.
function scopeTotal(
...
function scopeLabel(categoriesFiltre: string[] | null, gammesFiltre: string[] | null): string {
  ...
  return parts.length > 0 ? parts.join(" / ") : "tout le PF";
}
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">
                ...
                total en stock actuellement. Tu peux lancer plusieurs inventaires en meme temps, chacun sur son
                propre perimetre.
              </p>
            </div>
