...
// laisser tel quel (ignorerEcartLignePfAction, ne touche pas le stock, trace
...
export default async function InventairePfSessionDetailPage({ params }: { params: PageParams }) {
  ...
  // pas juste le compteur du lot de travail courant. Meme calcul que cote
  // MP.
  ...
  // propre URL - plusieurs sessions peuvent tourner en parallele, meme
  // fonctionnement que cote MP).
