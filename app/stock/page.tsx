...
import { canWritePageUser, getCurrentStockUser, getPageViewMap } from "@/lib/stock-auth";
...
const PF_HUB_LINKS = [
  { label: "Articles", href: "/articles", pageKey: "articlesHub" },
  { label: "Mouvements", href: "/mouvements", pageKey: "mouvementsHub" },
  { label: "Commandes", href: "/commandes", pageKey: "commandesListe" },
  { label: "Tableau cmd", href: "/tableau-commandes", pageKey: "tableauCommandes" },
  { label: "Dormant", href: "/stock-dormant", pageKey: "stockDormant" },
  { label: "Dormant sans cmd", href: "/stock-dormant-sans-commande", pageKey: "stockDormantSansCommande" },
  { label: "Client", href: "/clients", pageKey: "clients" },
  { label: "Statistique", href: "/statistique", pageKey: "statistiqueHub" },
] as const;
...
export default async function StockPage({
  ...
  const pageViewMap = await getPageViewMap(currentStockUser);
  const visibleHubLinks = PF_HUB_LINKS.filter((link) => pageViewMap[link.pageKey] ?? false);
