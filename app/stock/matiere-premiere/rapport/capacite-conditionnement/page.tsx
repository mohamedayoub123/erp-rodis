...
// Choisis un produit fini (article PF) et cette page dit combien de cartons
// de CE produit le stock actuel des articles de la recette Conditionnement
// (flacon, capsule, etiquette...) permet de fabriquer - la recette
// Fabrication (vrac) n'entre pas dans ce calcul, seule la recette
// Conditionnement (voir /production/recette-conditionnement/[id]) compte.
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-slate-600">
                Choisis un produit fini : combien de cartons le stock actuel des articles de sa
                recette Conditionnement (flacon, capsule, etiquette...) permet de fabriquer.
              </p>
            </div>
