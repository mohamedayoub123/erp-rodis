...
// Utilisee a la fois en session "en_cours" et en lecture seule
// (termine/annule) - un ecart confirme sur le dernier lot distribue peut
// tomber pile au moment ou la session bascule "termine" (plus rien a
// distribuer), donc la regularisation doit rester possible meme apres coup,
// sans quoi ces lignes restent fausses definitivement dans le stock systeme.
